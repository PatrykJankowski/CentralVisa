    ...
    <div class="container">
        <div class="grid grid-cols-12 gap-[30px]">
            <div class="col-span-12 lg:col-span-9">
                <h1 class="text-2xl lg:text-4xl font-bold m-0">Choose your subcscription fill up the form, and get your visa eligibility assesment</h1>
                <p class="font-light mt-6 mb-20">Choose your subscription</p>
            </div>
        </div>
        <div class="grid grid-cols-12 gap-[30px]">
